...
const roadmapItems = [
  ...
  },
  {
    ...
    description:
      "One-click sync with AWS S3 & Google Drive, enabling secure cloud storage without compromising encryption. Automated backup & recovery, ensuring data availability even in worst-case scenarios.",
  },
  {
    year: "Long-Term",
